...
)
{
    ...
    assert(TinySCF->bf_pair_scrval != NULL);
    ...
    TinySCF->df_tensor = (double*) ALIGN64B_MALLOC(temp_K_memsize);
    ...
    TinySCF->mem_size += (double) temp_K_memsize * 2;
...
void free_TinySCF(TinySCF_t TinySCF)
{
    ...
    ALIGN64B_FREE(TinySCF->bf_pair_scrval);
    ALIGN64B_FREE(TinySCF->df_sp_scrval);
